<script type="text/javascript">
    ...
    function access_updateCharttoday() {
        ...
        fetchjson().then(datapoints => {
            ...
            truycap.data.datasets[0].label = "Lượt Truy Cập : " + totalvisit;
        ...
        fetchjson().then(datapoints => {
            ...
            truycap.data.datasets[1].label = "Lượt Xem Trang : " + totalpv;
    ...
    function access_updateChart7day() {
        ...
        fetchjson().then(datapoints => {
            ...
            truycap.data.datasets[0].label = "Lượt Truy Cập";
            truycap.data.datasets[0].data = visitors;
            truycap.update();
        });
        fetchjson().then(datapoints => {
            ...
            truycap.data.datasets[1].label = "Lượt Xem Trang";
            truycap.data.datasets[1].data = pageViews;
            truycap.update();
        });
        fetchjson().then(datapoints => {
